...
diabetes_model = pickle.load(open('Models/diabetic_model.sav','rb'))

heart_disease_model = pickle.load(open('Models/heart_disease_model.sav','rb'))

parkinsons_model = pickle.load(open('Models/parkinson_disease.sav','rb'))

kidney_disease_model = pickle.load(open('Models/kindey.sav','rb'))
...
with st.sidebar:
    selected = option_menu('Disease Prediction System',
                           ['Ask AI', 'Diabetes Prediction' , 'Heart Disease Prediction',
                            'Parkinsons Prediction','Kidney Disease Prediction'],
                           icons =['alexa','activity','heart-pulse','person-wheelchair','hospital'],default_index=0)

if selected == "Ask AI":
    st.title("Healthcare Assistant Chatbot (Powered by Ollama)")
    st.write("Chat with the AI for guidance or queries about diseases.")
